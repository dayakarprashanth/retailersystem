...
<html lang="en">
<head>
    <title>Dealers SignUp Page</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" action="test1" enctype="multipart/form-data" method="post">
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Username is required">
						<input class="input100" type="text" value="<%=id%>" name="id" >
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Username is required">
						...
						<span class="focus-input100"></span>
                                            ...
                                            <b>Choose Distributors</b>
					</span>
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Dealer Name is required">
                                                <select class="input100" name="dealername">
                                                <% 
                                                    PreparedStatement ps22=con.prepareStatement("select * from distributor_register");
