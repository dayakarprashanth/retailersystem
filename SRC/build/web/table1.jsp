...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>View Door Category</b></h2><br>
        <table>
         <tr>
            <th>Door Category ID</th>
            <th>Door Category Name</th>
            <th>Category Code</th>
        </tr>
         <%
            Connection con=new DB().Connect();
            PreparedStatement ps1=con.prepareStatement("select * from doorcategory  ");
            ResultSet rs1=ps1.executeQuery();
            while(rs1.next()){
         %>
          <tr>
            <td><%=rs1.getString("door_category_id") %></td>
            <td><%=rs1.getString("door_category_name") %></td>
            <td><%=rs1.getString("door_category_code") %></td>
          </tr>
        <%} %>
       </table>
     </center>
