     ...
     <center>
        ...
        <table class="ali">
            <%
                ...
                String hg=(String)session.getAttribute("hg");
            %>
           ...
           <tr>
               <td>Door Glass Lock Group</td>
               <td><select name="glass5">
                       <option selected="" disabled="">Choose one</option>
                       <%
                            PreparedStatement p3=con.prepareStatement("select * from doorlocksystem where door_lock_group='"+hg+"' ");
                            ResultSet r3=p3.executeQuery();
                            while(r3.next()){
                       %>
                       <option value="<%=r3.getString("door_lock_name")%>"><%=r3.getString("door_lock_name")%></option><%}%>
                   </select></td></tr>
