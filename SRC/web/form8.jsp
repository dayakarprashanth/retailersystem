    ...
    <div id="maincontent">
     <center>
        ...
        <table class="ali">
           ...
           <tr>
               <td>Door Glass Type</td>
               <td><select name="glass1">
                       <option selected="" disabled="">Choose one</option>
                       <%
                            PreparedStatement p3=con.prepareStatement("select * from doorglasstype where door_glass_type_id>='1' and door_glass_type_id<='"+gg+"' ");
                            ResultSet r3=p3.executeQuery();
                            while(r3.next()){
                       %>
                       <option value="<%=r3.getString("door_glass_type_name")%>"><%=r3.getString("door_glass_type_name")%></option><%}%>
                   </select></td></tr>
