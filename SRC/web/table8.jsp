...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>View Door Finish Unit</b></h2><br>
        <table>
         <tr>
            <th>Door Finish ID</th>
            <th>Door Finish  Names</th>
            <th>Door Finish  Group</th>
            <th>Door Finish  Code</th>
        </tr>
         <%
            Connection con=new DB().Connect();
            PreparedStatement ps1=con.prepareStatement("select * from doorfinishunit ");
            ResultSet rs1=ps1.executeQuery();
            while(rs1.next()){
         %>
          <tr>
            <td><%=rs1.getString("door_finish_id") %></td>
            <td><%=rs1.getString("door_finish_name") %></td>
            <td><%=rs1.getString("door_finish_group") %></td>
            <td><%=rs1.getString("door_finish_code") %></td>
          </tr>
        <%} %>
       </table>
     </center>
