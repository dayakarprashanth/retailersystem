...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>Product Order Requests From Dealers</b></h2><br>
        ...
        <%
            ...
            PreparedStatement ps1=con.prepareStatement("select * from placeorder where dname='"+name+"'  ");
            ResultSet rs1=ps1.executeQuery();
            while(rs1.next()){
        %>
        <tr>
            <td style="color:green;"><%=rs1.getString("orderid") %></td>
                <td style="color:blue;"><%=rs1.getString("did") %></td>
                <td style="color:blue;"><%=rs1.getString("name") %></td>
                <td><%=rs1.getString("door_category") %></td>
                <td><%=rs1.getString("door_model") %></td>
                <td><%=rs1.getString("door_type") %></td>
                <td><%=rs1.getString("door_frame") %></td>
                <td><%=rs1.getString("door_width") %></td>
                <td><%=rs1.getString("door_height") %></td>
                <td><%=rs1.getString("door_panel") %></td>
                <td><%=rs1.getString("door_assembly") %></td>
                <td><%=rs1.getString("door_finish") %></td>
                <td><%=rs1.getString("glass_design") %></td>
                <td><%=rs1.getString("glass_type") %></td>
                <td><%=rs1.getString("glass_coating") %></td>
                <td><%=rs1.getString("glass_thickness") %></td>
                <td><%=rs1.getString("glass_handleset") %></td>
                <td><%=rs1.getString("glass_lock") %></td>
                <td><%=rs1.getString("color") %></td>
                <td><%=rs1.getString("predrill") %></td>
                <td><%=rs1.getString("frame_thickness") %></td>
                <th><%=rs1.getString("status") %></th>
                <th><%=rs1.getString("confrimed_by") %></th>
                 <%
