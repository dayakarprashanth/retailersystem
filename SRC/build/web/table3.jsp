...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>View Door Type</b></h2><br>
        <table>
         <tr>
            <th>Door Type ID</th>
            <th>Door Type Name</th>
            <th>Door Type Code</th>
        </tr>
         <%
            Connection con=new DB().Connect();
            PreparedStatement ps1=con.prepareStatement("select * from doortype  ");
            ResultSet rs1=ps1.executeQuery();
            while(rs1.next()){
         %>
          <tr>
            <td><%=rs1.getString("door_type_id") %></td>
            <td><%=rs1.getString("door_type_name") %></td>
            <td><%=rs1.getString("door_type_code") %></td>
          </tr>
        <%} %>
       </table>
     </center>
