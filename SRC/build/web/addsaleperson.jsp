...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>Add Sales Persons</b></h2><br>
        <form action="viewsaleperson">          
        <table class="ali">
            <%
                Connection con=new DB().Connect();
                PreparedStatement query=con.prepareStatement("select * from saleperson");
                ...
                if(i==0)
                    id="ID_1";
            %>
           <tr><td>Sales Person ID</td><td style="border-radius: 2px;"><input type="text" name="sid" value="<%=id%>" readonly=""></td></tr>
           <tr><td>Sales Person Name</td><td style="border-radius: 2px;"><input type="text" name="sname" required=""></td></tr>
