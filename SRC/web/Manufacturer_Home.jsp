...
<body>
    ...
    <!-- [ Main Content ] start -->
    <div class="pcoded-main-container" style="margin-left: 30%;">
                                ...
                                <div  class="col-xl-8 col-md-6">
                                    <div class="card Recent-Users">
                                        <div class="card-header">
                                            <h5 style="color: darkblue; font-weight: bold;">Welcome <label style="color:orangered;font-weight: bold;">Manufacturer</label></h5>
                                        </div>
                                                        ...
                                                        <tr class="unread">
                                                            ...
                                                            <td>
                                                                <%
                                                                    ...
                                                                    PreparedStatement p=con.prepareStatement("SELECT COUNT(*)as tot FROM dealer_register WHERE STATUS='Active' ");
                                                                    ResultSet r=p.executeQuery();
                                                                    if(r.next()){
                                                                %>
                                                                <h6 style="margin-left: -100px;font-weight: bold; color:Indigo;">Total Number of Dealers: <lable style="color:darkred;font-weight: bold;padding-left: 20px;"><%=r.getString("tot")%></lable></h6><%}%>
                                                            </td>
                                                            </tr>
                                                            <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:60px;" src="images/userslogo.png" alt="activity-user"></td>
                                                            <td>
                                                                <%
                                                                    PreparedStatement p1=con.prepareStatement("SELECT COUNT(*)as tot FROM distributor_register WHERE STATUS='Authorized' ");
                                                                    ResultSet r1=p1.executeQuery();
                                                                    if(r1.next()){
                                                                %>
                                                                <h6 style="margin-left: -100px;font-weight: bold; color:Indigo;">Total Number of Distributors: <lable style="color:darkred;font-weight: bold;padding-left: 20px;"><%=r1.getString("tot")%></lable></h6><%}%>
                                                            </td>
                                                            </tr>
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:60px;" src="images/orderslogo.jpg" alt="activity-user"></td>
                                                             <td>
                                                                <%
                                                                    PreparedStatement p2=con.prepareStatement("SELECT COUNT(*)as tot FROM placeorder where dname='Manufacturer' ");
                                                                    ResultSet r2=p2.executeQuery();
                                                                    if(r2.next()){
                                                                %>
                                                                <h6 style="margin-left: -100px;font-weight: bold; color:Indigo;">Total Number of Orders: <lable style="color:darkred;font-weight: bold;padding-left: 20px;"><%=r2.getString("tot")%></lable></h6><%}%>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
