     ...
     <center>
        ...
        <table>
         ...
         <%
            ...
            PreparedStatement ps1=con.prepareStatement("select * from doorcolor");
            ResultSet rs1=ps1.executeQuery();
            while(rs1.next()){
         %>
          <tr>
            <td><%=rs1.getString("door_color_id") %></td>
            <td><%=rs1.getString("door_color_name") %></td>
            <td><%=rs1.getString("door_color_group") %></td>
            <td><%=rs1.getString("door_color_code") %></td>
          </tr>
        <%} %>
       </table>
     </center>
