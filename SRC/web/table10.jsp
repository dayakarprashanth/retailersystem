...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>View Door Glass Type</b></h2><br>
        <table>
         <tr>
            <th>Door Glass Type ID</th>
            <th>Door Glass Type  Names</th>
            <th>Door Glass Type  Code</th>
        </tr>
         <%
            Connection con=new DB().Connect();
            PreparedStatement ps1=con.prepareStatement("select * from doorglasstype ");
            ResultSet rs1=ps1.executeQuery();
            while(rs1.next()){
         %>
          <tr>
            <td><%=rs1.getString("door_glass_type_id") %></td>
            <td><%=rs1.getString("door_glass_type_name") %></td>
            <td><%=rs1.getString("door_glass_type_code") %></td>
          </tr>
        <%} %>
       </table>
     </center>
