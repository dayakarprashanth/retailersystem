...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>View Door Width</b></h2><br>
        <table>
         <tr>
            <th>Door Width ID</th>
            <th>Door Width Size</th>
            <th>Door Width Group</th>
            <th>Door Width Code</th>
        </tr>
         <%
            Connection con=new DB().Connect();
            PreparedStatement ps1=con.prepareStatement("select * from doorwidth ");
            ResultSet rs1=ps1.executeQuery();
            while(rs1.next()){
         %>
          <tr>
            <td><%=rs1.getString("door_width_id") %></td>
            <td><%=rs1.getString("door_width_size") %></td>
            <td><%=rs1.getString("door_width_group") %></td>
            <td><%=rs1.getString("door_width_code") %></td>
          </tr>
        <%} %>
       </table>
     </center>
