    ...
    <div id="maincontent">
     <center>
        ...
        <table class="ali">
           ...
           <tr>
               <td>Door Pre-drill</td>
               <td><select name="glass7">
                       <option selected="" disabled="">Choose one</option>
                       <%
                            PreparedStatement p3=con.prepareStatement("select * from doorpredrill ");
                            ResultSet r3=p3.executeQuery();
                            while(r3.next()){
                       %>
                       <option value="<%=r3.getString("status")%>"><%=r3.getString("status")%></option><%}%>
                   </select></td></tr>
