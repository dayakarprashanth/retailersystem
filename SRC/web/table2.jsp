...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>View Door Model</b></h2><br>
        <table>
         <tr>
            <th>Door Model ID</th>
            <th>Door Model Name</th>
            <th>Door Model Code</th>
        </tr>
         <%
            Connection con=new DB().Connect();
            PreparedStatement ps1=con.prepareStatement("select * from doormodel  ");
            ResultSet rs1=ps1.executeQuery();
            while(rs1.next()){
         %>
          <tr>
            <td><%=rs1.getString("door_model_id") %></td>
            <td><%=rs1.getString("door_model_name") %></td>
            <td><%=rs1.getString("door_model_code") %></td>
          </tr>
        <%} %>
       </table>
     </center>
