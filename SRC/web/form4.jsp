        ...
        <table class="ali">
           ...
           <tr>
               ...
               <td><select name="handle">
                       ...
                       <%
                            PreparedStatement p3=con.prepareStatement("select * from doorhandling ");
                            ResultSet r3=p3.executeQuery();
                            while(r3.next()){
                       %>
                       <option value="<%=r3.getString("door_panel_name")%>"><%=r3.getString("door_panel_name")%></option><%}%>
                   </select></td></tr>
