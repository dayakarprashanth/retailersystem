        ...
        <table class="ali">
           ...
           <tr>
               ...
               <td><select name="finish">
                       ...
                       <%
                            PreparedStatement p3=con.prepareStatement("select * from doorfinishunit ");
                            ResultSet r3=p3.executeQuery();
                            while(r3.next()){
                       %>
                       <option value="<%=r3.getString("door_finish_name")%>"><%=r3.getString("door_finish_name")%></option><%}%>
                   </select></td></tr>
