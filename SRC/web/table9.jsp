...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>View Door Glass Design</b></h2><br>
        <table>
         <tr>
            <th>Door Glass Design ID</th>
            <th>Door Glass Design  Names</th>
            <th>Door Glass Design  Group</th>
            <th>Door Glass Design  Code</th>
        </tr>
         <%
            Connection con=new DB().Connect();
            PreparedStatement ps1=con.prepareStatement("select * from doorglassdesign ");
            ResultSet rs1=ps1.executeQuery();
            while(rs1.next()){
         %>
          <tr>
            <td><%=rs1.getString("door_glass_design_id") %></td>
            <td><%=rs1.getString("door_glass_design_name") %></td>
            <td><%=rs1.getString("door_glass_design_group") %></td>
            <td><%=rs1.getString("door_glass_design_code") %></td>
          </tr>
        <%} %>
       </table>
     </center>
