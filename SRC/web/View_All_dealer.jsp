...
<body>
    ...
    <div id="maincontent">
     <center>
         <form action="dadd.jsp">
         <button>+New dealer</button>
         </form>
         <br>
        ...
        <table>
         ...
         <%
            ...
            PreparedStatement ps1=con.prepareStatement("select * from dealer_register  ");
        ...
        %>  
            ...
            <td><a href="delaer_active.jsp?did=<%=rs1.getString("dealer_id") %>&&dname=<%=rs1.getString("username") %>"><img src="images/add.jpg" alt="Add" width=20,height=20></a>|<a href="Delete_dealer.jsp?did=<%=rs1.getString("dealer_id") %>&&dname=<%=rs1.getString("username") %>"><img src="images/delete.jpg" alt="delete" width=10,height=10></a> |  
            <a href="Edit_Profile1.jsp?did=<%=rs1.getString("dealer_id")%>&&dname=<%=rs1.getString("username")%>&&mail=<%=rs1.getString("mail")%>&&mobile=<%=rs1.getString("mobile")%>&&address=<%=rs1.getString("address")%>"><img src="images/edit.jpg" alt="edit" width=20,height=20></a></td> 
            <%
               }
