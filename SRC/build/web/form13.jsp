     ...
     <center>
        ...
        <table class="ali">
            <%
                ...
                String hs="";
                PreparedStatement p1=con.prepareStatement("select * from doorhandleset where door_handle_name='"+g4+"' ");
                ResultSet r1=p1.executeQuery();
                if(r1.next()){
                    hs=r1.getString("door_handle_id");
                }
            %>
           ...
           <tr>
               <td>Door Color</td>
               <td><%if(hs.equalsIgnoreCase("1")){ 
               %>
               <select name="glass6">
                       <option selected="" disabled="">Choose one</option>
                       <%
                            PreparedStatement p3=con.prepareStatement("select * from doorcolor  ");
                            ResultSet r3=p3.executeQuery();
                            while(r3.next()){
                       %>
                       <option value="<%=r3.getString("door_color_name")%>"><%=r3.getString("door_color_name")%></option><%}%>
                   </select>
                 <%}
                 else{
                 %>
                 <select name="glass6">
                       <option selected="" disabled="">Choose one</option>
                       <%
                            PreparedStatement p3=con.prepareStatement("select * from doorcolor where door_color_group='"+hs+"' ");
                            ResultSet r3=p3.executeQuery();
                            while(r3.next()){
                       %>
                       <option value="<%=r3.getString("door_color_name")%>"><%=r3.getString("door_color_name")%></option><%}%>
