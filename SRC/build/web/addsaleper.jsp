...
<body>
    ...
    <div id="maincontent">
     <center>
         <form action="addsaleperson.jsp">
         <button>+New Sales Person</button>
         </form>
         <br>
         <h2><b>View & Manage Sales Person</b></h2><br>
        <table>
         <tr>
            <tr>
                <th>Sales Person ID</th>
                <th>Sales Person_Name</th>
                <th>Password</th>
                <th>Mail</th>
                <th>Address</th>
                <th>Phone</th>
         ...
         <%                
            ...
            PreparedStatement ps1=con.prepareStatement("select * from saleperson");
            ResultSet rs1=ps1.executeQuery();
            System.out.print(ps1);
            while(rs1.next()){
        %>
               <tr>
                <td><%=rs1.getString("person_id") %></td>
            ...
            <td style="color:darkred; font-weight: bold;">Already <%=rs1.getString("status") %></td>
             <td><a href="person_Activate.jsp?did=<%=rs1.getString("person_id") %>&&dname=<%=rs1.getString("person_name") %>"><img src="images/add.jpg" alt="Add" width=20,height=20></a>|<a href="Delete_saleper.jsp?did=<%=rs1.getString("person_id") %>&&dname=<%=rs1.getString("person_name") %>"><img src="images/delete.jpg" alt="delete" width=10,height=10></a> |  
            <a href="Edit_Profilee.jsp?did=<%=rs1.getString("person_id")%>&&dname=<%=rs1.getString("person_name")%>&&mail=<%=rs1.getString("mail")%>&&mobile=<%=rs1.getString("phone")%>&&address=<%=rs1.getString("address")%>"><img src="images/edit.jpg" alt="edit" width=20,height=20></a></td> 
            <%
               }
