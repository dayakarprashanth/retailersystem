...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>View Door Frame Thickness</b></h2><br>
        <table>
         <tr>
            <th>Door Frame ID</th>
            <th>Door Frame Size</th>
            <th>Door Frame Group</th>
            <th>Door Frame Code</th>
        </tr>
         <%
            Connection con=new DB().Connect();
            PreparedStatement ps1=con.prepareStatement("select * from doorframethickness");
            ResultSet rs1=ps1.executeQuery();
            while(rs1.next()){
         %>
          <tr>
            <td><%=rs1.getString("door_frame_thickness_id") %></td>
            <td><%=rs1.getString("door_frame_thickness_size") %></td>
            <td><%=rs1.getString("door_frame_thickness_group") %></td>
            <td><%=rs1.getString("door_frame_thickness_code") %></td>
          </tr>
        <%} %>
       </table>
     </center>
