...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>Add New(Direct) Dealer Information</b></h2><br>
        <form action="test" enctype="multipart/form-data" method="post">            
        <table class="ali">
            <%
                Connection con=new DB().Connect();
                PreparedStatement query=con.prepareStatement("select * from dealer_register");
           ...
           <tr><td>Dealer Name</td><td style="border-radius: 2px;"><input type="text" name="username" required=""></td></tr>
