...
<body>
    ...
    <div id="maincontent">
     <center>
         <br>
         <h2><b>View Order Request Status</b></h2><br>
        <table>
         <tr>
            <tr>
                <th>Product ID</th>
        ...
        <%
            ...
            PreparedStatement ps1=con.prepareStatement("select * from placeorder where name='"+name+"'  ");
        ...
        <tr>
                ...
                <td style="color: red"><%=rs1.getString("status") %></td>
                <td style="color:purple;"><%=rs1.getString("confrimed_by") %></td>
               </tr>
        <%} %>
        </table>
     </center>
