...
<body>
    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light">
        <div class="m-header">
            ...
            <a href="sendorder.jsp" class="b-brand">
                   <div class="b-bg">
                       <i class="feather icon-trending-up"></i>
                   </div>
                                                        ...
                                                        <tr class="unread">
                                                            ...
                                                            <td>
                                                                <%
                                                                    ...
                                                                    PreparedStatement p=con.prepareStatement("SELECT COUNT(distributor_name)as tot FROM dealer_register WHERE username='"+name+"' ");
                                                                    ResultSet r=p.executeQuery();
                                                                    if(r.next()){
                                                                    
                                                                %>
                                                                <h6 style="margin-left: -100px;font-weight: bold; color:Indigo;">Total Number of Distributors:<lable style="color:darkred;font-weight: bold;padding-left: 20px;"><%=r.getInt("tot")%> </lable></h6><%}%>
                                                            </td>
                                                            </tr>
                                                        <tr class="unread">
                                                            ...
                                                            <td>
                                                                <%
                                                                    PreparedStatement p1=con.prepareStatement("SELECT COUNT(*)as tot FROM placeorder WHERE name='"+name+"' ");
