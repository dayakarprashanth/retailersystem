    ...
    <div id="maincontent">
     <center>
        ...
        <table class="ali">
           ...
           <tr>
               <td>Door Glass Handle Set</td>
               <td><select name="glass4">
                       <option selected="" disabled="">Choose one</option>
                       <%
                            PreparedStatement p3=con.prepareStatement("select * from doorhandleset ");
                            ResultSet r3=p3.executeQuery();
                            while(r3.next()){
                       %>
                       <option value="<%=r3.getString("door_handle_name")%>"><%=r3.getString("door_handle_name")%></option><%}%>
                   </select></td></tr>
