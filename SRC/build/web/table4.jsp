...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>View Door Frame</b></h2><br>
        <table>
         <tr>
            <th>Door Frame ID</th>
            <th>Door Frame Name</th>
            <th>Door Frame Code</th>
        </tr>
         <%
            Connection con=new DB().Connect();
            PreparedStatement ps1=con.prepareStatement("select * from doorframe  ");
            ResultSet rs1=ps1.executeQuery();
            while(rs1.next()){
         %>
          <tr>
            <td><%=rs1.getString("door_frame_id") %></td>
            <td><%=rs1.getString("door_frame_name") %></td>
            <td><%=rs1.getString("door_frame_code") %></td>
          </tr>
        <%} %>
       </table>
     </center>
