...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>View Door Glass Coating</b></h2><br>
        <table>
         <tr>
            <th>Door Glass Coating ID</th>
            <th>Door Glass Coating  Names</th>
            <th>Door Glass Coating  Group</th>
            <th>Door Glass Coating  Code</th>
        </tr>
         <%
            Connection con=new DB().Connect();
            PreparedStatement ps1=con.prepareStatement("select * from doorglasscoating");
            ResultSet rs1=ps1.executeQuery();
            while(rs1.next()){
         %>
          <tr>
            <td><%=rs1.getString("door_glass_coating_id") %></td>
            <td><%=rs1.getString("door_glass_coating_name") %></td>
            <td><%=rs1.getString("door_glass_coating_group") %></td>
            <td><%=rs1.getString("door_glass_coating_code") %></td>
          </tr>
        <%} %>
       </table>
     </center>
