...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>Update Dealer Information</b></h2><br>
         <%
              
              String dealer_id=request.getParameter("did");
              String username=request.getParameter("dname");
              String mail=request.getParameter("mail");
              String mobile=request.getParameter("mobile");
              String address=request.getParameter("address");       
         %>
        <form action="update_action_dealer.jsp">            
        <table class="ali">
           <tr><td>Dealer ID</td><td style="border-radius: 2px;"><input type="text" name="dealer_id" value="<%=dealer_id%>" readonly></td></tr>
           <tr><td>Dealer Name</td><td style="border-radius: 2px;"><input type="text" name="username" value="<%=username%>" readonly></td></tr>
