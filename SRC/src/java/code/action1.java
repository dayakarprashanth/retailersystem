...
public class action1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      PrintWriter out = response.getWriter();
        try {
            ...
            PreparedStatement ps=con.prepareStatement("insert into distributor_register(distributor_id,username,password,mail,mobile,file,address)values('"+m.get(0)+"','"+m.get(1)+"','"+m.get(2)+"','"+m.get(3)+"','"+m.get(4)+"','"+ms.get(0)+"','"+m.get(5)+"')");
                 ps.executeUpdate();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(action1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
