        ...
        <table class="ali">
           ...
           <tr>
               ...
               <td><select name="width">
                       ...
                       <%
                            PreparedStatement p3=con.prepareStatement("select * from doorwidth group by door_width_size ");
                            ResultSet r3=p3.executeQuery();
                            while(r3.next()){
                       %>
                       <option value="<%=r3.getString("door_width_size")%>"><%=r3.getString("door_width_size")%></option><%}%>
                   </select></td></tr>
