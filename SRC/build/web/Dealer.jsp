        ...
        <div class="navbar-wrapper">
            <div class="navbar-brand header-logo">
                <a href="index.html" class="b-brand">
                    ...
                    <span class="b-title">Dealers</span>
                </a>
            ...
            <div class="navbar-content scroll-div">
                <ul class="nav pcoded-inner-navbar">
                   ...
                   <!-- <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item ">
                        <a href="index.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-settings"></i></span><span class="pcoded-mtext">Manufacturer</span></a>
                    </li> -->
                      <!-- <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item ">
                        <a href="Distributor.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-book"></i></span><span class="pcoded-mtext">Distributors</span></a>
                    </li> -->
                      <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item active">
                        <a href="dealer.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-sidebar"></i></span><span class="pcoded-mtext">Dealers</span></a>
                    </li>
                    <li class="nav-item pcoded-menu-caption">
                        <label>other</label>
                    </li>
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=""><a href="index.html" class="">Send Order Requests</a></li>
                               <li class=""><a href="Distributor.html" class="">Receive confirmed Order Requests</a></li>
                                  <li class=""><a href="Distributor.html" class="">Send Orders to Distributors</a></li>
                    ...
                    <li style="display: none;" class="nav-item pcoded-menu-caption">
                        <label>Forms & table</label>
                    </li>
                    <li style="display: none;" data-username="form elements advance componant validation masking wizard picker select" class="nav-item">
                    ...
                    <li style="display: none;" data-username="Table bootstrap datatable footable" class="nav-item">
                    ...
                    <li style="display: none;" data-username="Charts Morris" class="nav-item"><a href="chart-morris.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-pie-chart"></i></span><span class="pcoded-mtext">Chart</span></a></li>
                    <li style="display: none;" data-username="Maps Google" class="nav-item"><a href="map-google.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-map"></i></span><span class="pcoded-mtext">Maps</span></a></li>
                    <li style="display: none;" class="nav-item pcoded-menu-caption">
                        <label>Pages</label>
                    </li>
                    <li style="display: none;" data-username="Authentication Sign up Sign in reset password Change password Personal information profile settings map form subscribe" class="nav-item pcoded-hasmenu">
                    ...
                    <li style="display: none;" data-username="Sample Page" class="nav-item"><a href="sample-page.html" class="nav-link"><span class="pcoded-micon"><i class="feather icon-sidebar"></i></span><span class="pcoded-mtext">Sample page</span></a></li>
                    <li style="display: none;" data-username="Disabled Menu" class="nav-item disabled"><a href="javascript:" class="nav-link"><span class="pcoded-micon"><i class="feather icon-power"></i></span><span class="pcoded-mtext">Disabled menu</span></a></li>
                </ul>
            </div>
        </div>
    </nav>
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            ...
                            <ul class="pro-body">
                                <li style="display: none;"><a href="javascript:" class="dropdown-item"><i class="feather icon-settings"></i> Settings</a></li>
                                <li><a href="javascript:" class="dropdown-item"><i class="feather icon-user"></i> Profile</a></li>
                                <li style="display: none;"><a href="message.html" class="dropdown-item"><i class="feather icon-mail"></i> My Messages</a></li>
                                <li style="display: none;"><a href="auth-signin.html" class="dropdown-item"><i class="feather icon-lock"></i> Lock Screen</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
                    ...
                    <div class="main-body">
                        <div class="page-wrapper">
                            ...
                            <div class="row">
                                    ...
                                    <div class="card daily-sales">
                                        <div class="card-block">
                                            ...
                                            <div class="row d-flex align-items-center">
                                                <div class="col-9">
                                                    <center><h3 class="f-w-300 d-flex align-items-center m-b-0"><i class="feather icon-arrow-up text-c-green f-30 m-r-10"></i>&nbsp;&nbsp;249</h3></center>
                                                </div>

                                                <div class="col-3 text-right">
                                                    <p style="visibility: hidden;" class="m-b-0">67%</p>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="card Monthly-sales">
                                        <div class="card-block">
                                            ...
                                            <div class="row d-flex align-items-center">
                                                <div class="col-9">
                                                    <h3 class="f-w-300 d-flex align-items-center  m-b-0"><i class="feather icon-arrow-down text-c-red f-30 m-r-10"></i> &nbsp;&nbsp; 2942</h3>
                                                </div>
                                                <div class="col-3 text-right">
                                                    <p style="visibility: hidden;" class="m-b-0">36%</p>
                                                </div>
                                            </div>
                                            <div class="progress m-t-30" style="height: 7px;">
                                ...
                                <div class="col-md-12 col-xl-4">
                                    <div class="card yearly-sales">
                                        <div class="card-block">
                                            ...
                                            <div class="row d-flex align-items-center">
                                                <div class="col-9">
                                                    <h3 class="f-w-300 d-flex align-items-center  m-b-0"><i class="feather icon-arrow-up text-c-green f-30 m-r-10"></i> &nbsp;&nbsp;8638</h3>
                                                </div>
                                                <div class="col-3 text-right">
                                                    <p style="visibility: hidden;" class="m-b-0">80%</p>
                                                </div>
                                            </div>
                                            <div class="progress m-t-30" style="height: 7px;">
                                ...
                                <!--[ Recent Users ] start-->
                                <div style="display: none;" class="col-xl-8 col-md-6">
                                ...
                                <div style="display: none;" class="col-xl-4 col-md-6">
                                ...
                                <div style="display: none;" class="col-md-12 col-xl-4">
                                ...
                                <div style="display: none;" class="col-md-6 col-xl-4">
                                    <div class="card card-social">
                                        <div class="card-block border-bottom">
                                            <div class="row align-items-center justify-content-center">
                                                <div class="col-auto">
                                ...
                                <!-- [ rating list ] end-->
                                <div style="display: none;" class="col-xl-8 col-md-12 m-b-30">
