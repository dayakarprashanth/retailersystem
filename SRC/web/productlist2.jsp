...
<body>
    ...
    <div id="maincontent">
     <center>
         <form action="add_distributor_by_salesperson.jsp">
        ...
        <table>
         ...
         %>
          <tr>
            ...
            <td><a href="Distributor_Activate_by_SalePerson.jsp?did=<%=rs1.getString("distributor_id") %>&&dname=<%=rs1.getString("username") %>"><img src="images/add.jpg" alt="Add" width=20,height=20></a> | <a href="Delete_Distributor_Salesperson.jsp?id=<%=rs1.getString("id") %>"><img src="images/delete.jpg" alt="delete" width=10,height=10></a> |  
            <a href="Edit_Profile_By_Salesperson.jsp?did=<%=rs1.getString("distributor_id")%>&&dname=<%=rs1.getString("username")%>&&mail=<%=rs1.getString("mail")%>&&mobile=<%=rs1.getString("mobile")%>&&address=<%=rs1.getString("address")%>"><img src="images/edit.jpg" alt="edit" width=20,height=20></a></td> 
            <%
               }
