        ...
        <table class="ali">
           ...
           <tr>
               ...
               <td>
                   ...
                   <% 
                    if((w.equalsIgnoreCase("10 feet")||w.equalsIgnoreCase("12 feet"))&&ha.equalsIgnoreCase("SPLS => OXXO")){
                   %>
                   ...
                   %>
                       ...
                       <%
                            PreparedStatement p3=con.prepareStatement("select * from doorassembly  ");
                            ResultSet r3=p3.executeQuery();
                            while(r3.next()){
                       %>
                       <option value="<%=r3.getString("door_assembly_name")%>"><%=r3.getString("door_assembly_name")%></option><%}%>
                   </select><%}%>
               </td></tr>
