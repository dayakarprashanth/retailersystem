...
<tr>                                                    
							...
							<td><%=rs1.getString("Dealer_name") %></td>
					         ...
					         <td style="color:red;">Already Confirmed </td>
					         	 <% }
					         		...
					         		%>
					         	<td><a href="ordercon.jsp?name=salemanager&&type=<%=rs1.getString("Type") %>&&disname=<%=rs1.getString("Distributor_name") %>&&dname=<%=rs1.getString("Dealer_name") %>&&did=<%=rs1.getString("Dealer_id") %>&&status=<%=rs1.getString("status") %>&&sno=<%=rs1.getString("sno") %>">Confirmed Order</a></td></tr>
					         	<%		
					         		}
 ...
 <a href="salemanager1.jsp">Click to back</a>
</body>
</html>