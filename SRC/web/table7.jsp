...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>View Door Assembly</b></h2><br>
        <table>
         <tr>
            <th>Door Assembly ID</th>
            <th>Door Assembly Names</th>
            <th>Door Assembly Group</th>
            <th>Door Assembly Notes</th>
            <th>Door Assembly Code</th>
        </tr>
         <%
            Connection con=new DB().Connect();
            PreparedStatement ps1=con.prepareStatement("select * from doorheight ");
            ResultSet rs1=ps1.executeQuery();
            while(rs1.next()){
         %>
          <tr>
            <td><%=rs1.getString("door_height_id") %></td>
            <td><%=rs1.getString("door_height_name") %></td>
            <td><%=rs1.getString("door_height_group") %></td>
            <td><%=rs1.getString("door_height_notes") %></td>
            <td><%=rs1.getString("door_height_code") %></td>
          </tr>
        <%} %>
       </table>
     </center>
