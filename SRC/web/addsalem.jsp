...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>Add Sales Manager</b></h2><br>
        <form action="viewsalemanager">          
        <table class="ali">
            <%
                Connection con=new DB().Connect();
                PreparedStatement query=con.prepareStatement("select * from salemanager");
                ...
                {
                    i++;
                    id="ID_"+(rs.getInt("sno")+1);
                }
                if(i==0)
                    id="ID_1";
            %>
           <tr><td>Sales Manager ID</td><td style="border-radius: 2px;"><input type="text" name="sid" value=<%=id%> readonly=""></td></tr>
           <tr><td>Sales Manager Name</td><td style="border-radius: 2px;"><input type="text" name="sname" required=""></td></tr>
           <tr><td>Password</td><td style="border-radius: 2px;"><input type="password" name="pass" required=""></td></tr>
           <tr><td>Mobile</td><td style="border-radius: 2px;"><input type="text" name="phone"  required></td></tr>
