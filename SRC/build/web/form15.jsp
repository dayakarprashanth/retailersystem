   ...
   <style>
    ...
    <div id="maincontent">
     <center>
        ...
        <form action="final_order_place.jsp">            
        <table class="ali">
            <%
            ...
            <tr><td>Door Glass Design</td><td><Input type="text" name="glass" value="<%=g%>" readonly=""></td></tr>
            <tr><td>Door Glass Type</td><td><Input type="text" name="glass1" value="<%=g1%>" readonly=""></td></tr>
            <tr><td>Door Glass Coating</td><td><Input type="text" name="glass2" value="<%=g2%>" readonly=""></td></tr>
            <tr><td>Door Glass Thickness</td><td><Input type="text" name="glass3" value="<%=g3%>" readonly=""></td></tr>
            <tr><td>Door Glass Handle Set</td><td><Input type="text" name="glass4" value="<%=g4%>" readonly=""></td></tr>
            <tr><td>Door Glass Lock Group</td><td><Input type="text" name="glass5" value="<%=g5%>" readonly=""></td></tr>
            <tr><td>Door Glass Color</td><td><Input type="text" name="glass6" value="<%=g6%>" readonly=""></td></tr>
            <tr><td>Door Pre-Drill</td><td><Input type="text" name="glass7" value="<%=g7%>" readonly=""></td></tr>
          
           <tr>
               <td>Frame Thickness</td>
               <td><select name="glass8">
                       <option selected="" disabled="">Choose one</option>
                       <%
                            PreparedStatement p3=con.prepareStatement("select * from doorframethickness  ");
                            ResultSet r3=p3.executeQuery();
                            while(r3.next()){
                       %>
                       <option value="<%=r3.getString("door_frame_thickness_size")%>"><%=r3.getString("door_frame_thickness_size")%></option><%}%>
                   </select></td></tr>
           <tr>
            <td>Choose Distributor</td>
            <td><select name="dname">
                <option selected="" disabled="">Choose one</option>
                <%
                     PreparedStatement p1=con.prepareStatement("select * from dealer_register where username='"+name+"' ");
                     ResultSet r1=p1.executeQuery();
                     while(r1.next()){
                %>
                <option value="<%=r1.getString("distributor_name")%>"><%=r1.getString("distributor_name")%></option><%}%>
            </select></td></tr>
           <tr> <td align="center" colspan="2"><input type="submit" value="Make Order" /></td></tr>
