     ...
     <center>
        ...
        <table class="ali">
            <%
                ...
                String gc="";
                PreparedStatement p1=con.prepareStatement("select * from doorglasscoating where door_glass_coating_name='"+g2+"' ");
                ResultSet r1=p1.executeQuery();
                if(r1.next()){
                    gc=r1.getString("door_glass_coating_group");
                }
            %>
           ...
           <tr>
               <td>Door Glass Thickness</td>
               <td><select name="glass3">
                       <option selected="" disabled="">Choose one</option>
                       <%
                            PreparedStatement p3=con.prepareStatement("select * from doorglassthickness where door_glass_thickness_id='"+gc+"' ");
                            ResultSet r3=p3.executeQuery();
                            while(r3.next()){
                       %>
                       <option value="<%=r3.getString("door_glass_thickness_name")%>"><%=r3.getString("door_glass_thickness_name")%></option><%}%>
                   </select></td></tr>
