...
<body>
    ...
    <div id="maincontent">
     <center>
         ...
         %>
        <form action="sendrequest_manufacturer"> 
         <table>
           	<tr><td><strong>Distributor_name:</strong></td><td>
           	<input type="text" name="dname"  style="border-radius: 2px;  color:black;" value="<%=name%>"></td></tr>
           	<tr><td><strong>Distributor_id: </strong></td><td>
           	<input type="text" name="did"  style="border-radius: 2px; color:black;" value="<%=did%>"></td></tr>
           	<tr><td><strong>Product Id: </strong></td><td>
           	<input type="text" name="pid" style="border-radius: 2px; color:black;" value="<%=pid%>"></td></tr>
           	<tr><td><strong>Product Type: </strong></td>
           	<td><input type="text" name="ptype" value="<%=ptype%>"></td></tr>
