...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>Update Sales Person Information</b></h2><br>
         <%
            String person_id=request.getParameter("did");
            String username=request.getParameter("dname");
            String mail=request.getParameter("mail");
            String mobile=request.getParameter("mobile");
            String address=request.getParameter("address");   
        %> 
        <form action="updatee.jsp">  
         <table class="ali">
            <tr><td>Sales Person ID</td><td style="border-radius: 2px;"><input type="text" name="person_id" value="<%=person_id%>" readonly></td></tr>
            <tr><td>Sales Person Name</td><td style="border-radius: 2px;"><input type="text" name="username" value="<%=username%>" readonly></td></tr>
