...
public class test1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps=con.prepareStatement("insert into dealer_register(dealer_id,username,password,mail,mobile,file,address,Type,distributor_name)values('"+m.get(0)+"','"+m.get(1)+"','"+m.get(2)+"','"+m.get(3)+"','"+m.get(4)+"','"+ms.get(0)+"','"+m.get(5)+"','InDirect','"+m.get(6)+"')");
                 ps.executeUpdate();
