     ...
     <center>
        ...
        <table class="ali">
            <%
                ...
                String gt="";
                PreparedStatement p1=con.prepareStatement("select * from doorglasstype where door_glass_type_name='"+g1+"' ");
                ResultSet r1=p1.executeQuery();
                if(r1.next()){
                    gt=r1.getString("door_glass_type_id");
                }
            %>
           ...
           <tr>
               <td>Door Glass Coating</td>
               <td><select name="glass2">
                       <option selected="" disabled="">Choose one</option>
                       <%
                            PreparedStatement p3=con.prepareStatement("select * from doorglasscoating where door_glass_coating_group='"+gt+"' ");
                            ResultSet r3=p3.executeQuery();
                            while(r3.next()){
                       %>
                       <option value="<%=r3.getString("door_glass_coating_name")%>"><%=r3.getString("door_glass_coating_name")%></option><%}%>
                   </select></td></tr>
