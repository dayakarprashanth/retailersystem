...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>Update Sales Manager Information</b></h2><br>
         <%
              String salem_id=request.getParameter("did");
        ...
        <table class="ali">
           <tr><td>Sales Manger ID</td><td style="border-radius: 2px;"><input type="text" name="salem_id" value="<%=salem_id%>" readonly></td></tr>
           <tr><td>Sales Manager Name</td><td style="border-radius: 2px;"><input type="text" name="username" value="<%=username%>" readonly></td></tr>
