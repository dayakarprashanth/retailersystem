...
<body>
    ...
    <div id="maincontent">
     <center>
         <h2><b>View Door Height</b></h2><br>
        <table>
         <tr>
            <th>Door Height ID</th>
            <th>Door Height Size</th>
            <th>Door Height Group</th>
            <th>Door Height Code</th>
        </tr>
         <%
         ...
         %>
          <tr>
            ...
            <td><%=rs1.getString("door_height_size") %></td>
