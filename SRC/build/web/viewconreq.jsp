     ...
     <center>
        ...
        <%
           Connection con=new DB().Connect();
            PreparedStatement p=con.prepareStatement("select * from placeorder ");
        ...
        <tr>
                ...
                <td style="color:red;">Already Order Confirmed </td>
                 <% }
                        else if(sta.equalsIgnoreCase("Forwarded")){
                %>
                 <td><a href="Confirm_Order.jsp?id=<%=r.getString("id")%>&&dname=<%=r.getString("dname")%>&&type=indirect" style="color:maroon;">Confirm Order</a></td>
                <%		
                    }
                        else{
                 %>
                <td><a href="Confirm_Order.jsp?id=<%=r.getString("id")%>&&did=<%=r.getString("did")%>&&type=direct" style="color:maroon;">Confirm Order</a></td>
