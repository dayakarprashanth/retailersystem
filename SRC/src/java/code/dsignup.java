 ...
 * @author ADMIN
 */
public class dsignup extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
         try {
            ...
            PreparedStatement ps=con.prepareStatement("insert into dealer_register(username,mobile,mail,password,file,address,Type)values('"+m.get(0)+"','"+m.get(1)+"','"+m.get(2)+"','"+m.get(3)+"','"+ms.get(0)+"','"+m.get(4)+"','"+m.get(5)+"')");
                 ps.executeUpdate();
                 System.out.println(ps);
                 out.println("<script type=\"text/javascript\">"); 			
	                out.println("alert(\"Register Successfully..\")");
	                out.println("</script>"); 
	                RequestDispatcher rd=request.getRequestDispatcher("dadd.jsp");
